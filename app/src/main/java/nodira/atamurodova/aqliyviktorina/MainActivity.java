...
import nodira.atamurodova.aqliyviktorina.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void performAction(ImageView  imageView, int selectedBoxPosition) {
        ...
        if (playerTurn == 1) {
            imageView.setImageResource(R.drawable.xbig);
            if (checkResults()) {
            ...
            imageView.setImageResource(R.drawable.obig);
            if (checkResults()) {
